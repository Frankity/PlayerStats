...
def players(word, word_eol, userdata):
    ...
    if command == "player":
        ...
        rank = '\002' + 'Rank: ' + '\002' + '\00302' + str(jdata['data']['rank']) + '\00302' 
        score = '\002' + '\00301' + 'Score: ' + '\00301' + '\002' + '\00302' + str(jdata['data']['score']) + '\00302' 
        kills = '\002' + '\00301' + 'Kills: ' + '\00301' + '\002' + '\00302' + str(jdata['data']['kills']) + '\00302' 
        deaths = '\002' + '\00301' + 'Deaths: ' + '\00301' + '\002' + '\00302' + str(jdata['data']['deaths']) + '\00302' 
